...
function Footer() {
    ...
    return(
        <div className="w-full bg-black pl-12 z-30  h-auto flex flex-col items-start md:items-center  py-8 ">
            <div className="flex flex-col justify-start md:w-3/4 text-white font-[400] md:flex-row md:justify-between ">
            ...
            <div className="flex flex-col md:w-3/4 text-white font-[400] mt-4 md:flex-row md:justify-between ">
